...
def scraping1(response, fh, coll, src):
...
def scraping2(response, fh, coll, src):
    data = html.fromstring(response.text)
...
def scraping3(response, fh, coll, src):
    data = html.fromstring(response.text)
...
def main():
    print '...running retailmenot spider'
    ...
    scraping1(response, fh, coll, url)
    scraping2(response, fh, coll, url)
    scraping3(response, fh, coll, url)
    fh.close()
    client.close()
